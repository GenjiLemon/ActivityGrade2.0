...
import com.laoluoli.java.activitygrade.dao.ActivityDao;
import com.laoluoli.java.activitygrade.dao.JudgeDao;
import com.laoluoli.java.activitygrade.dao.QrcodeDao;
...
import com.laoluoli.java.activitygrade.service.RedisService;
import com.laoluoli.java.activitygrade.service.WxService;
...
import static com.laoluoli.java.activitygrade.utils.CommonUtils.getRandomString;
import static com.laoluoli.java.activitygrade.utils.Network.uploadWxQrCode;
    ...
    public String getQRCodeUrl(Integer activityid, Integer type) {
        ...
        switch (type) {
            case 1:
                ...
                break;
            case 2:
                params.put("page", "pages/averagescoreranking/averagescoreranking");
                break;
            case 3:
                params.put("page", "pages/averagetruncatedrank/averagetruncatedrank");
                break;
            default:
                return null;
        }
