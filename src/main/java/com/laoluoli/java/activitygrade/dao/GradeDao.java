...
public interface GradeDao {
    ...
    @Results(id = "gradeMap", value = {
            //@Result(property = "player",column = "pid",one = @One(select = "com.laoluoli.java.activitygrade.dao.PlayerDao.findById",fetchType = FetchType.EAGER)),
            @Result(property = "judge", column = "jid", one = @One(select = "com.laoluoli.java.activitygrade.dao.JudgeDao.findById", fetchType = FetchType.EAGER)),
    })
